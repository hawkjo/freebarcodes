...
def prune_barcodes(arguments):
    ...
    tmp_fpath = fpath + '.tmp'
    sbg = generate.FreeDivBarcodeGenerator(bc_len, arguments.num_errors, bc_iter, threads=arguments.threads)
    sbg.Conway_closure(tmp_fpath=tmp_fpath, encode_sphere=False)
